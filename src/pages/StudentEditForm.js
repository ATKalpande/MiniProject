...
export function StudentEditForm() {
  ...
  const [student, setStudent] = useState({id:'' , name: '', subject: '', rollno: '' });
          ...
          <Row>
            <Col lg={4}>
              <Form.Group className="mb-3" >
                ...
                <Form.Control type="text" placeholder="Enter Course" name="subject" value={student.subject} onChange={handleFieldChange} />
              </Form.Group>
            </Col>
